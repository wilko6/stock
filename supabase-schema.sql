...
CREATE TABLE stock (
  ...
  location text NOT NULL CHECK (location IN ('Stock', 'Boutique 1', 'Boutique 2', 'Boutique 3')),
...
CREATE TABLE deliveries (
  id text PRIMARY KEY DEFAULT gen_random_uuid()::text,
  source text NOT NULL CHECK (source IN ('Stock', 'Boutique 1', 'Boutique 2', 'Boutique 3')),
  destination text NOT NULL CHECK (destination IN ('Stock', 'Boutique 1', 'Boutique 2', 'Boutique 3')),
